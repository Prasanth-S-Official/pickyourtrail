...
const[successPopup,setSuccessPopup]=useState(false);
  ...
  {
    const response = await axios.get(`https://ide-abfdabeabcbaed306741645dddffdfddfone.premiumproject.examly.io/proxy/8080/loan/getLoanById/${id}`);
  ...
  async function handleAddLoan() {
   ...
   try{
    ...
    if(id)
    {
      const response = await axios.put('https://ide-abfdabeabcbaed306741645dddffdfddfone.premiumproject.examly.io/proxy/8080/loan/updateLoan/'+id,requestObject);
    ...
    if (response.status == 200) {
      ...
      const response = await axios.post('https://ide-abfdabeabcbaed306741645dddffdfddfone.premiumproject.examly.io/proxy/8080/loan/addLoan',requestObject);
      console.log("response",response)
    if (response.status == 200) {
      setSuccessPopup(true);
    }
